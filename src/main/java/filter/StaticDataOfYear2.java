...
/**
 * Servlet Filter implementation class StaticDataOfYear2
 */
@WebFilter(dispatcherTypes = {
		...
		, urlPatterns = { "/StaticOfYear2.jsp" })
public class StaticDataOfYear2 implements Filter {

	/**
	 * Default constructor.
	 */
	public StaticDataOfYear2() {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		try {
			...
			session.setAttribute("slist4", list);

...
<body>
	...
	<div class="middle">
		...
		<div class="right">
			<form action="/web/motifyMess" method="post" class="info"
				enctype="multipart/form-data">
				修改个人信息：<br /> 名称：<input type="text" value="${user}"
					readonly="readonly" name="account" /> <br /> 头像： <input
					type="file" name="image" /> <br /> 性别： <select name="sex">
					<option value="1">男</option>
					<option value="0">女</option>
				</select> <br /> <input type="submit" value="修改">
			</form>
			<br />
			绑定第三方账号：<img src="http://qzonestyle.gtimg.cn/qzone/vas/opensns/res/img/Connect_logo_1.png" id="bindQQ"/>

...
<body>
	...
	<div class="middle">
		...
		<div class="right">
			<div class="info">
				标题&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;作者&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;日期&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;状态
				<br />
				<c:forEach var="p" items="${mlist}" varStatus="status">
				<a href="./showNews?id=${p.id }">${p.title}</a>&emsp;&emsp;${p.author }&emsp;&emsp;&emsp;${p.time }&emsp;&emsp;&emsp;&emsp;${p.ischeck }&emsp;&emsp;&emsp;
				<a href="/NewsSys/MotifyNews?id=${p.id }&step=1">修改</a>
				<a href="/NewsSys/CheckNews?check=0&id=${p.id }">删除</a>
				<br /> 
				</c:forEach>

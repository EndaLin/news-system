		...
		<div class="middle">
			...
			<div class="right">
				<div class="info">
					...
					<c:forEach var="p" items="${slist3}" varStatus="status" begin="<%=page_begin %>" end="<%=page_end %>">
					...
					<ul>
						<c:if test="${sessionScope.page_current != 1 }">
							<li>
								<a href="./StaticOfYear.jsp?begin=${sessionScope.page_current - 1 }">Prev</a>
							</li>
						</c:if>
						<c:if test="${sessionScope.page_current != sessionScope.page_total }">
							<li>
								<a href="./StaticOfYear.jsp?begin=${sessionScope.page_current + 1 }">Next</a>
							</li>
						</c:if>
					</ul>
